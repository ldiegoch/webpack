...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
	    for (var _iterator = _patients2.default[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        (0, _jquery2.default)('<li></li>').text(patient).appendTo(ul);
	    }
	} catch (err) {
	...
	(0, _jquery2.default)('<h2>Users</h2>').appendTo('body');
	var ulUsers = (0, _jquery2.default)('<ul></ul>').appendTo('body');
	var _iteratorNormalCompletion4 = true;
	var _didIteratorError4 = false;
	var _iteratorError4 = undefined;

	try {
	    for (var _iterator4 = _users2.default[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	        var user = _step4.value;

	        (0, _jquery2.default)('<li></li>').text(user).appendTo(ulUsers);
	    }
	} catch (err) {
